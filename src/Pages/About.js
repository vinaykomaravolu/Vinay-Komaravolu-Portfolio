        ...
        <div id="skills" className="flex p-4 flex-col flex-nowrap w-full h-full ">
            ...
            <div className="flex justify-center pr-12 pl-12 pt-24 pb-24 w-full h-full">
                <div className="flex flex-wrap content-center p-28 w-1/2 h-auto">
                    <h3 className="text-secondary font-bold text-2xl">My name is Vinay Komaravolu (he/him) and I am a University of Toronto computer science graduate who has a passion for graphics programming and web development. I am someone looking for new experiences and opportunities to showcase and apply my knowledge!</h3>
