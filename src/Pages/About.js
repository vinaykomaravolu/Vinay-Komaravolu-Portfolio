        ...
        <div id="skills" className="flex p-4 flex-col flex-nowrap w-full h-full ">
            ...
            <div className="m-auto flex justify-center h-full w-full pr-12 pl-12 pt-24 pb-24">
                <div className="flex flex-wrap content-center h-full w-full p-48">
                    <h3 className="text-secondary font-bold text-2xl">I am University of Toronto graduate who has a passion for graphics programming and web development. I am someone looking for new experiences and opportunities to showcase and apply my knowledge!</h3>
